...
def create_model(input_shape):
    ...
    model.add(tf.keras.layers.LSTM(100, activation=tf.keras.activations.tanh, recurrent_activation=tf.keras.activations.relu, input_shape=input_shape, name="forward", use_bias=True, bias_initializer="ones"))
